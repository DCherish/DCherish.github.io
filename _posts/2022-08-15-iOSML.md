...
　　👉 제 3의 객체를 반드시 필요로 함, 확실하게 처리 되었는지 알 수 없음  
...
👉 데이터의 특징을 추출하고 그 특징들의 패턴을 파악하는 머신러닝 알고리즘  
👋 이미지 처리 작업에 강점이 있음  
...
👉 RNN의 Gradient Vanishing Problem을 극복하기 위해 Hidden layer에 추가적으로 logic을 구현한 머신러닝 알고리즘  
