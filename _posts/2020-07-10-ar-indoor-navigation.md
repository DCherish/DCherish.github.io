...
ℹ Unity Project File + Server(java) File + AAR plugin + TensorFlow Model + Deep Learning(python) code  
...
<img src="{{ '/assets/img/diagram.jpg' }}" style="width: 800px; height: auto;">
</div>
...
<div style="text-align : center;">
<img src="{{ '/assets/img/equipment.jpg' }}" style="width: 800px; height: auto;">
</div>
...
<div style="text-align : center;">
<img src="{{ '/assets/img/kalmanfilter.jpg' }}" style="width: 500px; height: auto;">
</div>
...
<div style="text-align : center;">
<img src="{{ '/assets/img/data.gif' }}" style="width: 600px; height: auto;">
</div>
...
<div style="text-align : center;">
<img src="{{ '/assets/img/dnn.jpg' }}" style="width: 700px; height: auto;">
</div>
