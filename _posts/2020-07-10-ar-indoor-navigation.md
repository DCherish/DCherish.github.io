...
//UnityProject File + Server(java) File + AAR plugin + TensorFlow Model + Deep Learning(python) code  

<img src="{{ '/assets/img/diagram.jpg' }}" style="width: 500px; height: auto;" align="center">
...
<img src="{{ '/assets/img/kalmanfilter.jpg' }}" style="width: 500px; height: auto;" align="center">
...
<img src="{{ '/assets/img/data.gif' }}" style="width: 500px; height: auto;" align="center">
...
<img src="{{ '/assets/img/dnn.jpg' }}" style="width: 500px; height: auto;" align="center">
...
<img src="{{ '/assets/img/socket.gif' }}" align="center">

Client에서 수신된 신호 세기 값들을 Server로 전송하면 **Deep Learning**을 통하여 생성된 **학습 모델**을 통하여 좌표 값을 계산해 다시 Server에서 Client에게 Data가 전송하는 것을 확인할 수 있습니다.
