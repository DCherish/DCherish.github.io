...
## Jetpack
👉 androidx라는 패키지명으로 시작하는 다양한 라이브러리  
👋 recyclerview, viewpager2, drawerlayout, fragment  
...
👉 RNN의 **Gradient Vanishing Problem**을 극복하기 위해 Hidden layer에 logic을 추가적으로 구현한 머신러닝 알고리즘  
