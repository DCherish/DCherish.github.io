...
## 아키텍처 패턴 🆚 디자인 패턴 ✔️
👉 아키텍처 패턴  
　　👉 주어진 문맥 안에서 소프트웨어 아키텍처의 공통적인 발생 문제에 대해 일반적인, 재사용 가능한 해결책  
👉 디자인 패턴  
　　👉 소프트웨어 디자인에서 특정 문맥에서 공통적인 발생 문제에 대해 재사용 가능한 해결책  
...
## JDK 🆚 SDK
👉 JDK  
　　👉 개발자들이 JVM과 JRE에 의해 실행되고 구동될 수 있도록 자바 프로그램을 생성할 수 있게 해주는 개발 도구 모음  
👉 SDK  
